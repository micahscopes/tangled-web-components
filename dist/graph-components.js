(function () {
	...
	function nearbyEdgePoints(r1, r2) {
	  var c1 = center(r1),
	      c2 = center(r2);
	  var rad1 = rad(r1),
	      rad2 = rad(r2);
...
var require$$5 = Object.freeze({
	...
	var emitter$2 = index$4.emitter;
	var types = index$4.types;
	var string$1 = index$4.string;
	var object$2 = index$4.object;
	var number$3 = index$4.number;
	var array$1 = index$4.array;
...
var require$$3$3 = Object.freeze({
	...
	var factory$24 = index$6.factory;
	var name$22 = index$6.name;
...
var require$$0$14 = Object.freeze({
	...
	var matrices = interopDefault(index$3);
	...
	var setupSVG = function setupSVG(svg) {
	  ...
	  defs.append('svg:marker').attr('id', 'end-arrow').attr('viewBox', '0 -5 10 10').attr('refX', 10).attr('markerWidth', 5).attr('markerHeight', 5).attr('orient', 'auto').append('svg:path').attr('d', 'M0,-5L10,0L0,5').attr('fill', 'white');

	  defs.append('svg:marker').attr('id', 'start-arrow').attr('viewBox', '0 -5 10 10').attr('refX', 0).attr('markerWidth', 5).attr('markerHeight', 5).attr('orient', 'auto').append('svg:path').attr('d', 'M10,-5L0,0L10,5').attr('fill', 'white');
	};
	...
	var graphAllEdges = {
	  ...
	  refreshAnimation: function refreshAnimation(elem) {
	    ...
	    edgeLines.enter().append("path").style('marker-start', function (d) {
	      return d.direction <= 0 ? 'url(#start-arrow)' : '';
	    }).style('marker-end', function (d) {
	      return d.direction >= 0 ? 'url(#end-arrow)' : '';
	    });
	    edgeLines.attr("d", this.svgEdge).style('marker-start', function (d) {
	      return d.direction <= 0 ? 'url(#start-arrow)' : '';
	    }).style('marker-end', function (d) {
	      return d.direction >= 0 ? 'url(#end-arrow)' : '';
	    });
	...
	define$1('edges-adjacency-matrix', EdgesAllPairs.extend({
	  edges: function edges(elem) {
	    ...
	    combos = combos.map(function (c) {
	      return { source: c[0], target: c[1], direction: 1 };
	    });
	    console.log(combos);
	    return combos;
	  }
