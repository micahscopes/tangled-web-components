(function () {
	...
	var htmlElementPrototype = HTMLElement$2 ? HTMLElement$2.prototype : {};

	// Prevent double-calling with polyfill.

	var $prevName = createSymbol('name');
	var $prevOldValue = createSymbol('oldValue');
	var $prevNewValue = createSymbol('newValue');

	function preventDoubleCalling(elem, name, oldValue, newValue) {
	  return name === elem[$prevName] && oldValue === elem[$prevOldValue] && newValue === elem[$prevNewValue];
	}
	...
	function Component() {
	  ...
	  var elem = (typeof Reflect === 'undefined' ? 'undefined' : _typeof(Reflect)) === 'object' ? Reflect.construct(HTMLElement$2, args, this.constructor) : HTMLElement$2.call(this, args[0]);
